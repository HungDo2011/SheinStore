...
function LogInItem({ login = false }) {
    ...
    const handleBlurPassword = () => {
        ...
        } else if (!testPassword(valuePassword)) {
            setErrPassword(true);
        }
    };
    ...
    const handleBlurRePassword = () => {
        ...
        } else if (!verifyPassword(valuePassword, valueRePassword)) {
                ...
                <Form.Group bsPrefix={cx('input-group')}>
                    ...
                    <div className={cx('input-arena')}>
                        ...
                        <Form.Control
                            ...
                            type="password"
                        />
                        {errPassword ? <span className={cx('err-mess')}>Tối thiểu 8-10 ký tự</span> : <></>}
                    </div>
                    ...
                    <Button onClick={handleSubmit} bsPrefix={cx('btn-submit')} variant="dark">
            ...
            {login ? (
                <>
                    <div className={cx('login-other')}>
                        ...
                        <StyledFirebaseAuth uiConfig={config.uiConfig} firebaseAuth={firebase.auth()} />
                    </div>
